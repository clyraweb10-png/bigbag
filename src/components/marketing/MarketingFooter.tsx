...
const FOOTER_LINKS = {
  ...
  Solutions: [
    { label: "For Work", href: "/solutions#work" },
    { label: "Founders", href: "/solutions#founders" },
    { label: "Designers", href: "/solutions#designers" },
    { label: "Marketers", href: "/solutions#marketers" },
    { label: "Product Teams", href: "/solutions#product" },
  ],
  Resources: [
        ...
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="mt-4 text-sm text-muted-foreground leading-relaxed max-w-xs">
              Turn ideas into full-stack apps with AI. Build, preview, and deploy — without writing a line of code.
            </p>
