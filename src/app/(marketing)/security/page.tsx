...
const FAQS = [
  ...
  { q: "Which services process app-building requests?", a: "BigBag sends app-building prompts to above.dev for GLM 5.3 Flash inference. Preview sandboxes use E2B when configured, and URL reference analysis uses Firecrawl when requested. These services process only the data needed for the requested workflow." },
